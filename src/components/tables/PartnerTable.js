									...
									<Button
										...
										onClick={() =>
											customSortHandler(handleNAforSort(companies), (a, b) =>
												`${a.locations[0].address}, ${a.locations[0].zipcode} ${a.locations[0].city}`.localeCompare(
													`${b.locations[0].address}, ${b.locations[0].zipcode} ${b.locations[0].city}`
												)
											)
										}
									>
								...
								<th>
									<Button
										...
										onClick={() =>
											customSortHandler(
												[...companies],
												(a, b) => b.company.maxStudents - a.company.maxStudents
											)
										}
									>
